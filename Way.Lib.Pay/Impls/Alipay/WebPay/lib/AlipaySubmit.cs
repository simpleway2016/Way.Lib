...
namespace Com.Alipay
{
    ...
    class Submit
    {
        ...
        public Submit(Way.Lib.Pay.Alipay.Config config)
        {
            _pid = config.WebConfig.pid.Trim();
            _key = config.WebConfig.key.Trim();
            _input_charset = config.WebConfig.input_charset.Trim().ToLower();
            _sign_type = config.WebConfig.sign_type.Trim().ToUpper();
        }
        ...
        {
            string url = GATEWAY_NEW + "service=query_timestamp&partner=" + _pid + "&_input_charset=" + _input_charset;
            string encrypt_key = "";
