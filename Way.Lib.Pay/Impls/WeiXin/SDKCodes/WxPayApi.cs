...
namespace WxPayAPI
{
    class WxPayApi
    {
        ...
        */
        public static WxPayData Micropay(WxPayData inputObj,WxPayConfig config, int timeOut = 10)
        {
            ...
            string response = HttpService.Post( config, xml, url, false, timeOut);//调用HTTP通信接口以提交数据到API
        ...
        */
        public static WxPayData OrderQuery(WxPayData inputObj, WxPayConfig config, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(config,xml, url, false, timeOut);//调用HTTP通信接口提交数据
        ...
        */
        public static WxPayData Reverse(WxPayData inputObj, WxPayConfig config, int timeOut = 6)
        {
            ...
            string response = HttpService.Post(config,xml, url, true, timeOut);
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData RefundQuery(WxPayData inputObj, WxPayConfig config, int timeOut = 6)
	    {
        ...
        * @return 成功时返回，其他抛异常
        */
        public static WxPayData DownloadBill(WxPayData inputObj, WxPayConfig config, int timeOut = 6)
        {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData ShortUrl(WxPayData inputObj, WxPayConfig config, int timeOut = 6)
	    {
	    ...
	    * @return 成功时返回，其他抛异常
	    */
	    public static WxPayData CloseOrder(WxPayData inputObj, WxPayConfig config, int timeOut = 6)
	    {
